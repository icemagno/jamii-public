...
## 🚀 Status do Projeto: Sprint 3.8 em Andamento (Maio/2026)
...
*   **`pkg/trie` (v1.3):** Arquitetura *Bonsai Turbo* com **Verkle Tree (256-vias)** validada para produção (~4.2k TPS).
...
| **Verkle Trees** | **~200 TPS** | **Descentralização:** Foco em Stateless Clients com provas constantes e compactas. |
...
> **Nota:** A **Trie Factory** permite que a rede alterne entre performance bruta (SMT) ou provas compactas (Verkle) via configuração de consenso.
